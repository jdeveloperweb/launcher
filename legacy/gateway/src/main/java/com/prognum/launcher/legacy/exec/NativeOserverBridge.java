...
/**
 * Ponte NATIVA (JNA) entre o gateway e os programas "w" do oserver — substitui a antiga ponte
 * em Python. Faz o mesmo que o launcher.pas no fpfork/fpexecve:
 *
 ...
 *
 * O programa e chamado como `programa 6 6 <ip>` (igual a ponte Python: ParamStr(1)=fd leitura,
 * ParamStr(2)=fd escrita, ParamStr(3)=ip). Nenhuma logica de programa aqui — so o transporte.
 *
...
final class NativeOserverBridge {
    ...
    static byte[] exchange(String bin, Map<String, String> env, String cwd, String ip,
        ...
        // O fd 6 (resultado do dup2) nasce SEM cloexec; as duas pontas originais ganham cloexec
        // para nao vazarem para o programa (exceto se 'child' ja for 6 — ai nao pode fechar no exec).
