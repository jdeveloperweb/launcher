...
/**
 * Cripto do W_COP, portado FIEL do SCCI (pcrypt.pas / wcorp.pas). Validado contra
 * um request real do /aejs-l.
 *
 * REQUEST (front -> gateway): AES-128-CBC. Formato: "____" + salt(9) + base64(cifra).
 ...
 *
 * RESPONSE (gateway -> front): XOR posicional (funcao 'codifica' do wcorp.pas):
